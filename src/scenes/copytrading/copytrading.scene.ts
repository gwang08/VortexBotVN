...
import { CALLBACKS, ACCOUNT_CREATION_TEXT, IB_CODE, DEPOSIT_VIDEO_GUIDE_TEXT } from '../../common/constants';
import { ctStep1Keyboard, ctIbKeyboard, ctStep2Keyboard, ctStep3Keyboard, ctStep4Keyboard } from '../../common/keyboards';
import { ctIbMobileMedia, ctIbWebMedia, ctStep2Media, ctStep3Media, ctStep4Media, ctFinalMedia } from '../../common/media';
...
export class CopyTradingScene {
  ...
  async onAlreadyHavePuPrime(ctx: BotContext) {
    ...
    await this.botService.sendWithKeyboard(ctx, `Mã IB của tôi: ${IB_CODE}\n\nSau khi chuyển mã xong, gửi cho tôi email bạn dùng để tạo tài khoản để tôi xử lý giúp bạn nhé`, ctIbKeyboard());
  }
